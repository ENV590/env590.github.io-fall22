...
Here is a <a href="/docs/modules/PPTS/PSE_M3_P1_SmartGrids_Generation.pdf" > link </a> to the slide deck used in class.
...
Addional information and resources for the data presented in this module will be found below.
...
* How do we deal with energy source intermittency the advent and success of Smart Grids depend on the full roll out of Smart Meters? <br>
